...
// Debug: Log incoming variables to stderr
error_log("[API] REQUEST_URI=" . ($_SERVER['REQUEST_URI'] ?? 'NOT SET'));
error_log("[API] PATH_INFO=" . ($_SERVER['PATH_INFO'] ?? 'NOT SET'));
error_log("[API] SCRIPT_URL=" . ($_SERVER['SCRIPT_URL'] ?? 'NOT SET'));
error_log("[API] SCRIPT_NAME=" . ($_SERVER['SCRIPT_NAME'] ?? 'NOT SET'));
...
error_log("[API] FINAL REQUEST_URI=" . $_SERVER['REQUEST_URI']);
error_log("[API] REQUEST_METHOD=" . ($_SERVER['REQUEST_METHOD'] ?? 'NOT SET'));
